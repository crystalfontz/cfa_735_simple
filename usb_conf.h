 ...
 * Description:
 *
 * Config file for the STM32 USB Library.
 *
...
/*
 * This is the configuration for the STM32 USB device driver.
 *
 * This will define the callbacks and interrupts we'll handle in the application.
 * These defines are largely used in usb_istr.c.
 *
 */
